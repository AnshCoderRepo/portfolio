...
export default function FolderSection() {
  return (
    <section className="py-24 w-full bg-surface relative overflow-hidden flex flex-col items-center justify-center border-t border-surface-border">
      ...
      <RevealSection direction="up" className="max-w-xl text-center space-y-4 px-4 mb-12 z-10">
      ...
      <RevealSection direction="up" delay={0.1} className="w-full max-w-md mx-auto flex items-center justify-center p-6 bg-neutral-900/20 border border-neutral-900/80 rounded-3xl backdrop-blur-md shadow-2xl relative min-h-[380px] z-10">
