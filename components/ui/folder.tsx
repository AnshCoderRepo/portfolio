...
const Page = () => (
  <div className="w-full h-full bg-gradient-to-b from-[#f6f5fa] via-[#e4e2ef] to-[#d2d0e0] rounded-[13px] p-[10px_11px_8px] shadow-[0_4px_16px_rgba(0,0,0,0.30),_0_1px_4px_rgba(0,0,0,0.14)] flex flex-col gap-[5px] box-border">
